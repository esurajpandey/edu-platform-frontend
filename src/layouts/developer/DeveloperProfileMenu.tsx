...
export default function DeveloperProfileMenu({ actions }: DeveloperProfileMenuProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex min-h-[50px] w-full items-center gap-2.5 rounded-[22px] border border-surfaceSoft bg-surface px-2.5 py-1.5 shadow-sm transition hover:border-primary sm:min-h-[50px] sm:w-auto sm:px-3"
      >
      ...
      {isOpen ? (
        ...
        >
          <div className="border-b border-surfaceSoft px-3 py-3">
            ...
            <p className="mt-1 text-xs text-textLight">Platform Administrator</p>
          </div>
